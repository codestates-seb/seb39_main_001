...
const NewMeeting = () => {
  ...
  return (
    <NewMeetingPageContainer>
      ...
      <HeaderTemplate formData={formData} setFormData={setFormData} company={company} setCompany={setCompany} />
      <Title>모임을 소개해주세요!</Title>
      <input type='text' placeholder='제목을 입력해주세요' onChange={titleInputHandler} />
